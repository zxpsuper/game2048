...
export default class HTMLActuator {
  ...
  public scoreContainer: HTMLElement
  public bestContainer: HTMLElement
  ...
  public normalizePosition(position: Position) {
    return { x: position.x + 1, y: position.y + 1 }
  }

  /**形成位置类名 */
  public positionClass(position: Position) {
